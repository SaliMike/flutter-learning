...
import 'package:flutter_pet_adoption_ui/datas/owner_data.dart';
import 'package:flutter_pet_adoption_ui/datas/pets_data.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  Widget _buildPetCategory(bool isSelected, String category) {
    return GestureDetector(
      onTap: () => print('Seleted $category'),
      child: Container(
        margin: EdgeInsets.all(10.0),
        width: 80.0,
        decoration: BoxDecoration(
          color: isSelected ? Theme.of(context).primaryColor : Color(0xFF8F2F7),
          borderRadius: BorderRadius.circular(20.0),
          border: isSelected
              ? Border.all(
                  width: 8.0,
                  color: Color(0xFFED8D3),
                )
              : null,
        ),
        child: Center(
